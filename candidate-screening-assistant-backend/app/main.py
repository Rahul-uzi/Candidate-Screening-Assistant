...
app = FastAPI(
    title="Candidate Screening Assistant API",
    description="AI-powered resume screening, semantic search, and interview question preparation",
    version="1.0.0"
)
...
async def root():
    return {
        "message": "Candidate Screening Assistant API is running!",
        "version": "1.0.0",
        "endpoints": {
            "upload": "/api/upload",
            "search": "/api/search",
